...
BIN_DIR="./bin"
RESULTS_DIR="./results"
RESULTS_CSV="$RESULTS_DIR/resultados_quick.csv"

SEQ_SRC="$SRC_DIR/s5p.cpp"
OMP_SRC="$SRC_DIR/s5p_openmp.cpp"     # debe existir en el mismo directorio
GLOBAL_SRC="$SRC_DIR/s5p_global.cu"
SHARED_SRC="$SRC_DIR/s5p_shared.cu"
...
echo "========================================="
echo " FASE 1: COMPILACION (version rapida)"
echo "========================================="
...
echo "========================================="
echo " FASE 2: EJECUCION (version rapida)"
echo "========================================="
